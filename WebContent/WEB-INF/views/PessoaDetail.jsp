...
<body>
	...
	<h1 class="font-weight-bold"
		...
		Santa Catarina - Editar um Cliente</h1>
	...
	<div
		...
		<form action="/ProjetoFinal/pessoaUpdate" method="POST"
	...
	<a href="/ProjetoFinal/pessoas">
		<button type="button" class="btn btn-primary"
			style="margin-left: 1100px; margin-top: -196px;">Voltar</button> <!-- Optional JavaScript -->
